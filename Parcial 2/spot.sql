...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2023 a las 04:25:28
...
(5, 'el komander', 'foto.jpg'),
(1, 'gerardo ortiz', 'foto.jpg'),
(2, 'grupo arriesgado', 'foto.jpg'),
(3, 'natanael cano', 'foto.jpg'),
(4, 'peso pluma', 'foto.jpg');
...
--
-- Volcado de datos para la tabla `spoti_albumes`
--

INSERT INTO `spoti_albumes` (`id`, `artista_id`, `nombre`) VALUES
(1, 1, 'entre dios y el diablo'),
(2, 2, 'con los pies en la tierra '),
(3, 3, 'nata kong'),
...
--
-- AUTO_INCREMENT de la tabla `spoti_albumes`
--
ALTER TABLE `spoti_albumes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `album_canciones`
  ...
  ADD CONSTRAINT `album_canciones_ibfk_3` FOREIGN KEY (`album_id`) REFERENCES `spoti_albumes` (`id`);
